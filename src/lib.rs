...
pub use commands::{Command, IecCommand};
pub use device::*;
pub use error::{Error, Result};
pub use transfer::Protocol;
...
const DEFAULT_USB_LOOP_SLEEP: Duration = Duration::from_millis(10);
#[allow(dead_code)]
const DEFAULT_USB_RESET_SLEEP: Duration = Duration::from_millis(100); // Full USB spec settling time

// Control protocol values
const BULK_IN_ENDPOINT: u8 = 3 | constants::LIBUSB_ENDPOINT_IN;
const BULK_OUT_ENDPOINT: u8 = 4 | constants::LIBUSB_ENDPOINT_OUT;

const XUM_STATUSBUF_SIZE: usize = 3;
const XUM_DEVINFO_SIZE: usize = 8;
const XUM_MAX_XFER_SIZE: usize = 32768;
